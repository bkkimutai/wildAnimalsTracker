import org.bkkimutai.models.AnimalAbstract;
...
public class SightingsTest {
    ...
    public void equals_returnsTrueIfNameTypeAreSame_true() {
        Sightings firstSight = new Sightings (1, "Zone A", 1);;
        Sightings secondSight = new Sightings (1, "Zone A", 1);
    ...
    public void find_returnsSightingsWithSameId_firstSight() {
        Sightings firstSight = new Sightings (1, "Zone A", 1);
        firstSight.save();
        Sightings secondSight = new Sightings (2, "Zone B", 1);
        secondSight.save();
